...
ItemMenus.forEach(ItemMenu => {
    ...
    ItemMenu.querySelector(".item-btn").innerHTML += `
...
const sections = AccountSettings.querySelectorAll(".fields section");
...
const isAlreadyActive = ItemMenu.classList.contains("active");
...
setTimeout(() => {FrameSs[index].classList.add("active");
...
setTimeout(() => {AccountSettings.classList.add("active");},400);
setTimeout(() => {deactivate();Frames.forEach(Frame => {Frame.style.overflowY="hidden";});},800);
...
let originalFirst = "Camellia";
let originalLast = "Lawrence";
let originalEmail = "camellialawrence@gmail.com";
let originalPhone = "+1 010 332 9043";
let originalCountry = "America";
let originalCity = "Los Angeles";
